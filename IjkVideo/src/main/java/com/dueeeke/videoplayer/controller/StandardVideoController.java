...
public class StandardVideoController extends BaseVideoController implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    private AdvancedCountdownTimer countDownTimer=null;
    private GifView   redtime=null;
...
//        moreMenu.setOnClickListener(this);
    ...
    public void setCountDownTimer(AdvancedCountdownTimer countDownTimer, GifView redtime){
