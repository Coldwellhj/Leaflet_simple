package leaflet.miaoa.qmxh.leaflet_simple.ui.widget.LoadMoreRecyclerViewPacket;
...
import leaflet.miaoa.qmxh.leaflet_simple.ui.widget.CircularProgress;
...
public class LoadMoreRecyclerView extends RecyclerView {
    ...
    private RelativeLayout auto_progress;
...
//                    animationDrawable.start();
                    ...
                    //不是用图片动画
                    if (loadType == LoadType.AUTO_LOAD) {
                        foot_tv=(TextView)itemView.findViewById(R.id.foot_tv);
                        auto_progress=(RelativeLayout)itemView.findViewById(R.id.auto_progress);
                    } else {
                        loadmore=(TextView)itemView.findViewById(R.id.loadmore);
                        circularProgress=(CircularProgress)itemView.findViewById(R.id.circularProgress);
    ...
    public void autoCallback(){
        auto_progress.setVisibility(GONE);
//        foot_tv.setVisibility(VISIBLE);
    }
    //刷新时
    public void autoRefreshCallback(){
        if (auto_progress!=null){
            auto_progress.setVisibility(VISIBLE);
        }
