...
public class SellerHomeShowedAdapter extends BaseAdapter {
    ...
    public SellerHomeShowedAdapter(Context mContext, List<ListActivityBean.Adv> advsList) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = View.inflate(mContext, R.layout.item_seller_home_showadv, null);
