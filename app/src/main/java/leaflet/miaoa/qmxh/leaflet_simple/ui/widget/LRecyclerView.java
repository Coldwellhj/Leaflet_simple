...
public class LRecyclerView extends RecyclerView {
    ...
    private com.github.jdsjlzx.recyclerview.LRecyclerView.LScrollListener mLScrollListener;
    ...
    public void addItemDecoration(){
       this.addItemDecoration(new MyDividerItemDecorationForNews(context));
    }
    /**
     * 设置是否已加载全部
     * @param noMore
    ...
    public void setLScrollListener(com.github.jdsjlzx.recyclerview.LRecyclerView.LScrollListener listener) {
