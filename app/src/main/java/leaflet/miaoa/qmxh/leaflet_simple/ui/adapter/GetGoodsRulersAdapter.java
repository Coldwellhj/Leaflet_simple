 ...
 */
public class GetGoodsRulersAdapter extends RecyclerView.Adapter<GetGoodsRulersAdapter.ViewHolder>{
    private List<String > introduceList = new ArrayList<String>();
    Context mContext;

    public GetGoodsRulersAdapter(Context mContext, List<String > introduceList) {
