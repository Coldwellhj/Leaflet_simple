...
import leaflet.miaoa.qmxh.leaflet_simple.ui.personaluser.mall.payfor.ManagerAddressActivity;
...
public class Personal_mine_Fragment extends Fragment implements View.OnClickListener{
    ...
    private RelativeLayout rl_buyed_goods;
    private RelativeLayout rl_manager_address;
...
//        EnvUtils.setEnv(EnvUtils.EnvEnum.SANDBOX);//沙箱
        view = inflater.inflate(R.layout.activity_personal_mine_, null, false);
        initView();
    ...
    private void initView() {
        ...
        rl_buyed_goods=(RelativeLayout)view.findViewById(R.id.rl_buyed_goods);
        rl_manager_address=(RelativeLayout)view.findViewById(R.id.rl_manager_address);
        ...
        rl_buyed_goods.setOnClickListener(this);
        rl_manager_address.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
          ...
          case R.id.rl_switch_seller:
              ...
              editor.putInt("umark", 0);
              editor.commit();
             Intent intent3 =new Intent(getActivity(),SellerHomePageActivity.class);
            ...
            case R.id.rl_setting:
                ...
                intent5.putExtra("flag","personal");
                startActivity(intent5);
                break;
            case R.id.rl_buyed_goods:
                Intent intent6 =new Intent(getActivity(),BuyAfterActivity.class);
                startActivity(intent6);
                break;
            case R.id.rl_manager_address:
                Intent intent7 =new Intent(getActivity(),ManagerAddressActivity.class);
        ...
        if (requestCode == 0) {
            switch (resultCode) {
                case Activity.RESULT_OK:
                    ...
                    uImg= bundle.getString("photoName");
...
//
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            mybalance=response;
                            value_of_loan.setText(mybalance+"元");
